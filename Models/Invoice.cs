...
namespace Website_QLPT.Models
{
    ...
    public class Invoice : ISoftDelete
    {
        ...
        // Fees are now mapped to DB explicitly
        [Display(Name = "Tiền điện (VND)")]
        [Column(TypeName = "decimal(18,0)")]
        public decimal ElectricityFee { get; set; }

        [Display(Name = "Diễn giải tính tiền điện")]
        public string? ElectricityCalculationDetails { get; set; }

        [Display(Name = "Tiền nước (VND)")]
        [Column(TypeName = "decimal(18,0)")]
